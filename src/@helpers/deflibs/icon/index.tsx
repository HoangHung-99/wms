...
export type TAntDesign = keyof typeof AntDesignName
export type TEntypo = keyof typeof EntypoName
export type TEvilIcons = keyof typeof EvilIconsName
export type TFeather = keyof typeof FeatherName
export type TFontAwesome = keyof typeof FontAwesomeName
export type TFontAwesome5 = keyof typeof FontAwesome5Name
export type TFoundation = keyof typeof FoundationName
export type TIonicons = keyof typeof IoniconsName
export type TMaterialCommunityIcons = keyof typeof MaterialCommunityIconsName
export type TMaterialIcons = keyof typeof MaterialIconsName
export type TOcticons = keyof typeof OcticonsName
export type TSimpleLineIcons = keyof typeof SimpleLineIconsName
export type TZocial = keyof typeof ZocialName
export type TSocialIcon = "angellist" | "envelope" | "codepen" | "envelope" | "etsy" | "facebook" |
...
export class IconIonicons extends Component<{ name: TIonicons } & IconProps> {
  render() {
    return (
      <Ionicons  {...this.props} />
    );
...
export class IconMaterialCommunity extends Component<{ name: TMaterialCommunityIcons } & IconProps> {
  render() {
    return (
